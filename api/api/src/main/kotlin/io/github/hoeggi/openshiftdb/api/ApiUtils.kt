...
fun Api(port: Int, baseUrl: BasePath = "http://localhost"): Api = ApiImp(
    ...
    LoggingApi.api(port, baseUrl)
)

interface Api : OcApi, PostgresApi, EventsApi, LoggingApi
private class ApiImp(
    val oc: OcApi,
    val postgres: PostgresApi,
    val eventsApi: EventsApi,
    val logApi: LoggingApi
) : Api,
    OcApi by oc,
    PostgresApi by postgres,
    EventsApi by eventsApi,
    LoggingApi by logApi
