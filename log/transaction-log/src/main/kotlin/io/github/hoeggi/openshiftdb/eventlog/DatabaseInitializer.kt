...
internal object DatabaseInitializer {
    operator fun invoke() = lazy {
        val driver = JdbcSqliteDriver("jdbc:sqlite:${dbFilePath.absolutePath}")
        migrateIfNeeded(driver, OpenshiftDbGui.Schema)
...
internal fun migrateIfNeeded(driver: SqlDriver, schema: SqlDriver.Schema) {
    val oldVersion =
